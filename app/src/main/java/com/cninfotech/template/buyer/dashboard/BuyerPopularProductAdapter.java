...
public class BuyerPopularProductAdapter extends RecyclerView.Adapter<BuyerPopularProductAdapter.MyViewHolder> {
    ...
    public BuyerPopularProductAdapter(Context context, List<Product> productList) {
    ...
    @NonNull
    @Override
    public BuyerPopularProductAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = null;
        itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_buyer_popular_product, parent, false);
        return new MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final BuyerPopularProductAdapter.MyViewHolder holder, int position) {
