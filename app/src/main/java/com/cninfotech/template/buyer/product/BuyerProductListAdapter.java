...
public class BuyerProductListAdapter extends RecyclerView.Adapter<BuyerProductListAdapter.MyViewHolder> {
    ...
    public BuyerProductListAdapter(Context context, List<Product> productList) {
    ...
    @NonNull
    @Override
    public BuyerProductListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = null;
    ...
    @Override
    public void onBindViewHolder(@NonNull final BuyerProductListAdapter.MyViewHolder holder, int position) {
