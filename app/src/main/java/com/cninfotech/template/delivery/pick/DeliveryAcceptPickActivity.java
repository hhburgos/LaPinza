...
public class DeliveryAcceptPickActivity extends AppCompatActivity {
    Button btnDelivered;
    CardView btnBuyerChat;
    CardView btnSellerChat;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_delivery_pick_accept_delivered);
        ...
        btnSellerChat = findViewById(R.id.cvSellerChat);
        btnBuyerChat = findViewById(R.id.cvBuyerChat);

        btnDelivered.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(getApplicationContext(),DeliverySuccessActivity.class));
                finish();
            }
        });
        ...
        btnBuyerChat.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("Username", "Buyer");
                startActivity(intent);
            }
        });

        btnSellerChat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ChatMessageActivity.class);
